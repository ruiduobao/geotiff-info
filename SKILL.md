---
name: geotiff-info
description: 'Zero-dependency Python tool for reading GeoTIFF file metadata.  Parses TIFF IFD manually using only Python standard library.  Supports CRS, resolution, bands, corner coordinates, and batch scanning.'
---
